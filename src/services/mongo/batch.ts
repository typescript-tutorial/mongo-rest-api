...
export class MongoBatchInserter<T> {
  ...
  write(list: T[]): Promise<number> {
    ...
    return insertMany(this.collection, list, this.idName);
  }
}
export class MongoBatchUpdater<T> {
  ...
  write(list: T[]): Promise<number> {
    ...
    return updateMany(this.collection, list, this.idName);
  }
}
export class MongoBatchWriter<T> {
  ...
  write(list: T[]): Promise<number> {
    ...
    return upsertMany(this.collection, list, this.idName);
  }
}
